      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <StatCard
            icon={DollarSign}
            title="Total Spent"
            value={`GHS ${parseFloat(stats.total_spent || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
            color="bg-green-600"
          />
          <StatCard
            icon={Package}
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm mt-1">View our wholesale catalog and place bulk orders</p>
              </div>
            </div>
          </button>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className={`font-medium ${partnerData?.is_active ? 'text-green-600' : 'text-red-600'}`}>
